...
function fixture(){
 ...
 for(const file of ['theme.js','data/thailand-provinces.js','data/demo-data.js','metrics.js','model.js','landscape.js','leaderboard.js','supply-ui.js','data/demo-map-context.js','location-map.js','branch-photos.js','decision-ui.js','app.js'])vm.runInContext(fs.readFileSync(path.join(prototype,file),'utf8'),ctx,{filename:file});
