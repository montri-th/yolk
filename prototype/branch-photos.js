...
(function (global) {
  ...
  function inner(s) {
    ...
    return `<div class="branch-photos-head"><div><h2>${uiIcon('photo')}${tr(s,'รูปสาขา','Branch photos')}</h2><p>${tr(s,'เห็นสาขาชัดขึ้น ก่อนออกสำรวจ','See the site before your visit.')}</p></div><span class="photo-count">${s.photos.length} / ${MAX}</span></div>
