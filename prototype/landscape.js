...
(function (global) {
  ...
  function patternPanel(area) {
    ...
    if (!active) {
      ...
      else if (area.supply.unverified>0) reasons.push(text('เมื่อยืนยันแบรนด์แล้ว ระดับ Supply อาจเปลี่ยน','Unclassified brands may change the high/low supply level for Bangchak or competitors'));
