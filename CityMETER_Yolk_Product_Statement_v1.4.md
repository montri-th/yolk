...
machine_contract: contracts/product.v1.4.json
implementation_plan: IMPLEMENTATION_PLAN_v1.4.md
criteria_contract: contracts/criteria.v1.4.json
experience_contract: contracts/experience.v1.3.json
asset_manifest: contracts/ds-assets.v1.4.json
public_data_policy: synthetic_only
production_status: proposed_not_deployed
---

# CityMETER: Yolk — Product statement v1.4
...
เอกสารนี้เป็นข้อกำหนดผลิตภัณฑ์ของ v1.4 อ่านคู่กับ [แผนลงมือพัฒนา](IMPLEMENTATION_PLAN_v1.4.md), [สัญญาสำหรับเครื่อง](contracts/product.v1.4.json) และ [เกณฑ์ v1.4](contracts/criteria.v1.4.json) รุ่นนี้แยก **คัดทำเล** ออกจาก **จัดอันดับ** ให้ชัด: เลือกความเข้มของ Demand ด้วย Tier, เลือกรูปแบบทำเลที่ต้องการ แล้วปรับน้ำหนักเพื่อเรียงทำเลที่ผ่านเกณฑ์ เกณฑ์อาคาร/กิจกรรมและ Supply ตั้งต้นยังใช้ชุดเดิม

## สถานะของรุ่นนี้

| ส่วน | มีให้ทดลองในเว็บ v1.4 | สิ่งที่ dev ต้องทำในระบบจริง |
|---|---|---|
...
**REQ-DS-01:** ใช้ **Landometer DS 0.9.4** ตาม [วิธีเชื่อม asset](DS_ASSET_INTEGRATION.md) และ [manifest ระบุไฟล์/บทบาท/hash](contracts/ds-assets.v1.4.json) ไม่สร้างโลโก้หรือสี canonical ขึ้นใหม่ ตัวอักษรหลัก 17 px มือถือ / 18 px จอใหญ่, controls 16 px, metadata เป้าหมาย 14 px ตาม adapter ของผลิตภัณฑ์
...
| **P3** | Area CRUD + Demand/Supply + รูปแบบตลาด + ทีมทำงานร่วมกัน | ขอบเขตหลักของ Yolk v1.4; custom boundaries/road analysis ทำเป็น capability ต่อ |
| **P4** | ยอดขายราย transaction/สาขา และข้อมูลสมาชิก | แยกเป็น private-data track; ยังไม่มีในพรีวิว |

เลข **v1.4 เป็นรุ่นของพรีวิว** ส่วน **P1–P4 เป็นระยะความสามารถทางธุรกิจ** จึงไม่ควรนำมาเทียบเป็นเลขเดียวกัน
...
**เริ่มงาน dev:** ใช้ [IMPLEMENTATION_PLAN_v1.4.md](IMPLEMENTATION_PLAN_v1.4.md) เลือกหนึ่งงานตาม dependency แล้วส่งทั้ง implementation, ผลทดสอบ และรายการที่ยังไม่ยืนยัน ห้ามถือว่า UI จำลองเท่ากับ backend ที่พร้อมใช้งานจริง
